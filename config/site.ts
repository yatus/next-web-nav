    ...
    "items": [
      {
        "icon": "",
        "title": "Rin 博客模板",
        "desc": "基于Cloudflare技术栈的动态博客模板",
        "link": "https://howtobuildwebsite.club/rin"
      },
      {
        "icon": "",
        "title": "Next.JS 样板",
        "desc": "支持最新Next.JS 15的完整项目模板",
        "link": "https://howtobuildwebsite.club/nextjs"
      },
      {
        "icon": "",
        "title": "SaaS 样板模板",
        "desc": "包含现代化UI组件的SaaS项目启动模板",
        "link": "https://howtobuildwebsite.club/saas"
      },
      {
        "icon": "",
        "title": "免费着陆页模板",
        "desc": "专为营销设计的Next.JS着陆页模板",
        "link": "https://howtobuildwebsite.club/landing"
      },
      {
        "icon": "",
        "title": "FRE123 导航模板",
        "desc": "一键搭建免费资源导航网站的完整方案",
        "link": "https://howtobuildwebsite.club/fre123"
      },
      {
        "icon": "",
        "title": "开源项目画廊",
        "desc": "展示优秀开源项目的精美画廊模板",
        "link": "https://howtobuildwebsite.club/gallery"
      },
      {
        "icon": "",
        "title": "WebStack 导航",
        "desc": "静态响应式网址导航，仿WebStack.cc设计",
        "link": "https://howtobuildwebsite.club/webstack"
      },
      {
        "icon": "",
        "title": "AI工具导航",
        "desc": "一键部署属于自己的AI工具导航站",
        "link": "https://howtobuildwebsite.club/ai-nav"
      },
      {
        "icon": "",
        "title": "GPTs 应用商店",
        "desc": "第三方GPTs应用展示和分享平台",
        "link": "https://howtobuildwebsite.club/gpts"
      },
      {
        "icon": "",
        "title": "Vercel 模板中心",
        "desc": "Vercel官方提供的丰富模板库，即用即部署",
        "link": "https://howtobuildwebsite.club/vercel-templates"
      }
    ]
  },
  {
    ...
    "items": [
      {
        "icon": "",
        "title": "Reddit 子社区",
        "desc": "精选Reddit社区列表，获取第一手行业资讯",
        "link": "https://howtobuildwebsite.club/reddit"
      },
      {
        "icon": "",
        "title": "Google SEO 基础",
        "desc": "Google官方SEO指南，学习搜索引擎优化基础",
        "link": "https://howtobuildwebsite.club/google-seo"
      },
      {
        "icon": "",
        "title": "Ahrefs 趋势网站",
        "desc": "实时跟踪热门趋势网站，发现新兴机会",
        "link": "https://howtobuildwebsite.club/ahrefs-trends"
      }
    ]
  },
  {
